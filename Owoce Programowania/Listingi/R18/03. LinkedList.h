...
// Węzły również są tworzone za pomocą szablonu klasy
#ifndef LINKEDLIST_H
#define LINKEDLIST_H

//*********************************************
// Szablon ListNode służy to tworzenia klasy węzła
// listy łączonej.
//*********************************************
...
public:
  ...
  ListNode<T> *next; // Zmienna wskazująca następny węzeł
...
{
private:
  ListNode<T> *head;  // Wskaźnik nagłówka listy
...
{
  ListNode<T> *newNode;  // Zmienna wskazująca nowy węzeł
  ListNode<T> *nodePtr;  // Zmienna do przeglądania listy
...
//***************************************************
// Funkcja displayList() wyświetla wartości zapisane we wszystkich
// węzłach listy wskazywanej przez nagłówek head.
//***************************************************
...
{
  ListNode<T> *newNode;                // Wskaźnik nowego węzła
  ListNode<T> *nodePtr;                // Zmienna do przeglądania listy
  ListNode<T> *previousNode = nullptr; // Wskaźnik poprzedniego węzła
...
{
  ListNode<T> *nodePtr;       // Zmienna do przeglądania listy
  ListNode<T> *previousNode;  // Zmienna wskazująca poprzedni węzeł
...
{
  ListNode<T> *nodePtr;  // Zmienna do przeglądania listy
  ListNode<T> *nextNode; // Zmienna wskazująca następny węzeł
